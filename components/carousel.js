import React, {
  ...
  const ChakraCarousel = ({ children, gap }) => {
    ...
    useEffect(() => {
      ...
      if (isGreaterThanXL) {
        setItemWidth(200 + (sliderWidth / 3 - gap));
        setMultiplier(0.35);
        setConstraint(1);
      }
      ...
      <>
        ...
        <Flex w={`${itemWidth}px`} mt={`${gap / 2}px`} mx="auto">
          <Button
            ...
            minW={0}
          >
            <ChevronLeftIcon color={useColorModeValue("gray.800", "whiteAlpha.900")} boxSize={9} />
          </Button>
          ...
          <Progress
            ...
            sx={{
              "> div": {
                backgroundColor: useColorModeValue("gray.800", "whiteAlpha.900")
              }
            }}
          />
          ...
          <Button
            ...
            minW={0}
          >
            <ChevronRightIcon color={useColorModeValue("gray.800", "whiteAlpha.900")} boxSize={9} />
          </Button>
        </Flex>
      </>
    );
